...
app.get('/', (req, res)=>{
    let url = 'https://api.themoviedb.org/3/movie/1011985?api_key=fa74adda0bc3dfae6b00ee34cef0c88b';
    axios.get(url)
    .then(response => {
...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?query=${userMovieTitle}&api_key=fa74adda0bc3dfae6b00ee34cef0c88b`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=fa74adda0bc3dfae6b00ee34cef0c88b&language=en-US';
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=9c329ee3`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
